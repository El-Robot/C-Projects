...
It will read the std input and creates a matrix
represented by a 1d array that is n x n long.
it creates then frees this array dynamically.
The function will print a path that is found recursively,
using recursiveFindPath() */
